...
import { Search, ClipboardClock, Filter } from "lucide-react"
    ...
    <SidebarInset>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <div className="flex min-h-[400px] flex-1 flex-col items-center justify-center rounded-xl border border-dashed bg-muted/50 p-4 text-center">
          <ClipboardClock className="mb-4 h-12 w-12 text-muted-foreground opacity-20" />
          <p className="text-muted-foreground">
            Detailed activity logs of all internal operations will be shown
            here.
          </p>
        </div>
      </div>
