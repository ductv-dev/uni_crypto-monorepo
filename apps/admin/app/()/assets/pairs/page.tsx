        ...
        <div className="flex items-center gap-2 px-4">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbLink href="/assets">Assets & Markets</BreadcrumbLink>
              </BreadcrumbItem>
              <BreadcrumbSeparator className="hidden md:block" />
              <BreadcrumbItem>
                <BreadcrumbPage>Trading Pairs</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
        </div>
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <div className="flex min-h-[400px] flex-1 flex-col items-center justify-center rounded-xl border border-dashed bg-muted/50 p-4 text-center">
          <p className="text-muted-foreground italic">
            Market pair management and configuration will be implemented here.
          </p>
        </div>
      </div>
    </SidebarInset>
