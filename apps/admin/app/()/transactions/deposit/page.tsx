...
import { Search, ArrowDownCircle, Filter } from "lucide-react"
      ...
      <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
        ...
        <div className="flex items-center gap-2">
          <div className="relative max-w-sm flex-1">
            ...
            <Input placeholder="Search by Hash, User ID..." className="pl-8" />
          </div>
        </div>
        ...
        <div className="flex min-h-[400px] flex-1 flex-col items-center justify-center rounded-xl border border-dashed bg-muted/50 p-4 text-center">
          <ArrowDownCircle className="mb-4 h-12 w-12 text-muted-foreground opacity-20" />
          <p className="text-muted-foreground">
            Deposit transactions list will be shown here.
          </p>
        </div>
      </div>
    </SidebarInset>
